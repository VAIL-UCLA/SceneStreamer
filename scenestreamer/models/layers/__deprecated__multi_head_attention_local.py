...
import scenestreamer
from scenestreamer.models.ops.attention import attention_utils_v2
    ...
    def forward(
        ...
        **kwargs
        ...
        if ctx_rpe_value is not None:
            ...
            attn_output = scenestreamer.models.ops.attention.attention_utils_v2.attention_value_computation(
