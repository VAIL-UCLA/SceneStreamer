...
from scenestreamer.tokenization.motion_tokenizers import (
    DeltaDeltaTokenizer,
...
from scenestreamer.utils import rotate
...
class BicycleModelTokenizerFixed0124(BaseTokenizer):
    ...
    def __init__(self, config):
        ...
        if os.environ.get("SCENESTREAMER_VERBOSE_STARTUP") == "1":
    ...
    def _detokenize_a_step_backward(
        ...
        # TODO: This line is wrong. Some invalid action will have non-neg1 value.
    ...
    def _detokenize_a_step(
        ...
        **kwargs
        ...
        mask = (action == -1) | (action == START_ACTION) | (action == END_ACTION) | (~current_valid_mask)
        action[mask] = 0
        action_expanded = action.reshape(B, T_action, N, 1).expand(B, T_action, N, 1).clone()
