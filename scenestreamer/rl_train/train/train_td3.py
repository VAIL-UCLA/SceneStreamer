...
from scenestreamer.rl_train.train.ScenarioOnlineEnvWrapper import ScenarioOnlineEnvWrapper
from scenestreamer.rl_train.train.customized_td3 import CustomizedTD3, Closed_Loop_TD3
from scenestreamer.rl_train.train.scenestreamer_rl_generator import SceneStreamerRLScenarioGenerator
...
class Monitor(gym.Wrapper):
    ...
    def reset(self, **kwargs) -> GymObs:
        ...
        # PZH: hardcoded here to discard seed to avoid bug in ScenarioEnv
        if "seed" in kwargs:
            kwargs.pop("seed")
            ...
            for key in self.info_keywords:
                ...
                if ep_data.dtype == object:
                    ...
                    try:
                        ...
                        ep_info["epsum_{}".format(key)] = np.sum(ep_data)
                    except:
                        pass
...
class CustomizedFormalevalCallback(EvalCallback):
    ...
    def _log_success_callback(self, locals_, globals_):
        ...
        if locals_["done"]:
            ...
            # for k in [
            #     "route_completion", "cost", "arrive_dest", "out_of_road", "crash", "episode_reward",
            #     "episode_energy", "route_completion", "total_cost", "max_step",
            #     "crash"
            # ]:
            #     if k in info:
...
def create_env(
        ...
        need_monitor=False,
        closed_loop=False,
        closed_loop_generator="SceneStreamer",
        model_name=None,
        no_adaptive=False,
        generator_hf_repo=None,
        generator_hf_file=None,
        generator_ckpt_path=None,
):
    if closed_loop:
        if closed_loop_generator == "SceneStreamer":
            assert model_name is not None
            generator = SceneStreamerRLScenarioGenerator(
                model_name,
                huggingface_repo=generator_hf_repo,
                huggingface_file=generator_hf_file,
                checkpoint_path=generator_ckpt_path,
            )
        elif closed_loop_generator == "SCGEN":
            raise ValueError("SCGEN is not supported yet.")
            generator = SCGEN_Generator("0202_midgpt", mode='SCGEN')
        elif closed_loop_generator == "CAT":
            raise ValueError("CAT is not supported yet.")
...
def create_eval_env(eval_config, ):
...
def closed_loop_train(
        ...
        exp_name="td3", source_data=None, closed_loop_generator="SceneStreamer",
        model_name=None, resumed_step=0, num_eval_envs=None, no_adaptive=False,
        generator_hf_repo=None, generator_hf_file=None, generator_ckpt_path=None):
    assert seed is not None
    ...
    train_env = create_env(config_train, need_monitor=True, closed_loop=True,
                           ...
                           generator_hf_repo=generator_hf_repo, generator_hf_file=generator_hf_file,
...
def train_wrapper(
        ...
        closed_loop_dir=None, closed_loop_generator="SceneStreamer", model_name=None, resumed_step=0,
    ...
    if not closed_loop:
        ...
        closed_loop_train(
            ...
            generator_hf_repo=generator_hf_repo,
            generator_hf_file=generator_hf_file,
            generator_ckpt_path=generator_ckpt_path,
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--generator_hf_repo", type=str, help="HuggingFace repo for the SceneStreamer generator")
    parser.add_argument("--generator_hf_file", type=str, help="HuggingFace checkpoint file for the SceneStreamer generator")
    parser.add_argument("--generator_ckpt_path", type=str, help="Local checkpoint path for the SceneStreamer generator")
    ...
    config_train = dict(
        ...
        # "/home/yuxin/scenestreamer/mixed_selected_scgen_diverse_coll_training", # "/home/yuxin/scenestreamer/mixed_selected_CAT_training", # "/home/yuxin/scenestreamer/mixed_training_500_TF", # SCGEN_waymo_training_500
    ...
    train_wrapper(
        ...
        generator_hf_file=args.generator_hf_file,
