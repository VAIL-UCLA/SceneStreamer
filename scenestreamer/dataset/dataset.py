            ...
            if self.config.DATA.USE_CACHE:
                ...
                if cache_path.is_file():
                    ...
                    try:
                        ...
                        if self.return_scenario_description and "raw_scenario_description" not in cache:
                            missing_required_keys.append("raw_scenario_description")
                        for required_key in (
                        ...
                        if self.config.MODEL.NAME == "scenestreamer" and "encoder/traffic_light_state" not in cache:
                            missing_required_keys.append("encoder/traffic_light_state")
                        ...
                        if missing_required_keys:
                            ...
                            if self.use_cache_logged is False:
                                print(f"[dataset] Reusing cached preprocessing from {cache_folder}")
                                print(f"[dataset] Cache files available: {len(list(cache_folder.glob('*')))}")
