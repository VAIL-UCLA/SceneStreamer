"""
PZH from: https://github.com/LTH14/mar/blob/fe470ac24afbee924668d8c5c83e9fec60af3a73/models/diffloss.py#L23
"""
import math
...
from scenestreamer.diffusion.create_diffusion import create_diffusion
...
class DiffLoss(nn.Module):
    ...
    def __init__(
        ...
        self.net = SimpleMLPAdaLN(
            ...
            out_channels=target_channels * 2 if use_vlb_loss else target_channels,  # for vlb loss
        ...
        # self.train_diffusion = create_diffusion(
        #     timestep_respacing="", noise_schedule="cosine", predict_xstart=predict_xstart
        # )
        # self.gen_diffusion = create_diffusion(
        #     timestep_respacing=num_sampling_steps, noise_schedule="cosine", predict_xstart=predict_xstart
        # )
